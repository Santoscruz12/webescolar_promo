    ...
    <div class="contenidot">
        ...
        <div class="contenido_flext">
            ...
            <div class="contenido_flex_imagent">
                <img class="contenido_flex_imagen_tamañot" src="/innova/webescolar_promo/assets/image/Administra_con_solo_un_clic.png"
                    alt="Click">

                <div class="contenido_flex_imagen_appt">

                    <img class="contenido_flex_imagen_emailt" src="/innova/webescolar_promo/assets/image/Email.png" alt="Email">
                    <img class="contenido_flex_imagen_emailt" src="/innova/webescolar_promo/assets/image/11.png" alt="Email">
                    <img class="contenido_flex_imagen_emailt" src="/innova/webescolar_promo/assets/image/Mensajes.png" alt="Email">

                    <img class="contenido_flex_imagen_emailt" src="/innova/webescolar_promo/assets/image/WhatsApp.png" alt="Email">
                    <img class="contenido_flex_imagen_emailt" src="/innova/webescolar_promo/assets/image/Instagram.png" alt="Email">
