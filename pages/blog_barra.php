<div class="blog-containerbg">
  ...
  <div class="blog-mainbg">
    <div class="blog-buttonbg">
      <button>Más temas de interés</button>
    </div>

    
      <div class="blog_barra1">
        <img src="/webescolar_promo/assets/image/Servicios_escolares.png" alt="Deserción estudiantil">
    ...
    <!--
      ...
      <div class="blog-contentbg">
        <div class="blog-imagebg">
          <img  src="/webescolar_promo/assets/image/Imagen_blog.png" alt="Deserción estudiantil">
        </div>
